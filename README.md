...
<a href="https://www.typescriptlang.org/">
  <img
    ...
    width="20%"
    title="@typescript-package/listeners - A lightweight TypeScript library for managing listeners."
  />
</a>

## @typescript-package/listeners
...
A **lightweight** TypeScript library for managing listeners.
...
```bash
npm install @typescript-package/listeners --save-peer
```
